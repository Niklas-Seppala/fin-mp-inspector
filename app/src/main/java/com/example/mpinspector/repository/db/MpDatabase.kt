...
@Database(version = 1, entities = [MemberOfParliamentModel::class], exportSchema = false)
    ...
    companion object {
        ...
        fun getInstance(): MpDatabase {
            synchronized(this) {
                ...
                if(instance == null) {
                    instance = Room.databaseBuilder(MyApp.appContext, MpDatabase::class.java, "mp-db")
